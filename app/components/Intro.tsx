...
const Intro = () => {
    return (
        <div className=" md:flex mt-[40px] md:mt-0 gap-4 mx-auto items-center dark:text-stone-100 justify-center h-auto z-50">
           ...
           <p className=" text-sm tracking-tight  leading-5 font-grey-reg md:p-0 p-2 text-cente md:text-start md:bg-transparent dark:text-stone-200  text-gray-700 backdrop-blur-sm md:backdrop-blur-0 rounded-md bg-black/5">
           ...
           <div className="md:w-3/12 w-full md:justify-items-end justify-items-center  md:flex-1">
                <Image className=" rounded-md backdrop-blur-sm z-50 w-[50%] md:w-36" src={image} width={100 } height={100}  alt="hi"/>
           </div>
        </div>
    )
};
