...
export function CustomDock({
  ...
  return (
    <div className={isMobile && header ? "fixed hidden  -top-5 justify-center inset-0 items-start h-fit z-50" :"fixed flex -top-8 md:justify-center items-start z-50   inset-0 md:top-[25%] md:bottom-[25%] md:h-fit  md:items-center md:right-[85%] md:left-40 " }>
      ...
      <TooltipProvider>
        <Dock direction="middle" orientation={isMobile ? "horizontal" : "vertical"} className="dark:border-stone-200">
                ...
                <TooltipTrigger asChild>
                  <Link
                    ...
                    className={cn(
                      ...
                      "size-12 dark:text-stone-100 rounded-full",
                    )}
                  >
          ...
          <Separator orientation={isMobile ? "vertical" : "horizontal"} className="h-full dark:border-stone-100 dark:text-stone-100" />
          ...
          <DockIcon>
            <Tooltip>
              <TooltipTrigger asChild>
                <div className="size-12 rounded-full hover:bg-stone-100 dark:hover:bg-stone-100/10 dark:text-stone-100  flex justify-center items-center ">
                  {resolvedTheme === "light" ? (
                    <Moon className=" size-4" onClick={() => setTheme("dark")}/>
                  ): (
                    <Sun className=" size-5 " onClick={() => setTheme("light")}/>
                  )}
                </div>
              </TooltipTrigger>
              <TooltipContent>
