    ...
    <div className="flex flex-col gap-4 pb-[40px]">
        ...
        <div className="flex pr-4 pl-4 flex-wrap md:gap-y-1 gap-x-[2px] gap-y-[3px] md:gap-x-2">
            {SKILLS.map((item,index) => (
                <div className=" backdrop-blur-3xl bg-black/90 dark:bg-stone-100/80 md:pr-[1%] md:pl-[1%] md:pt-[0.5%] md:pb-[0.5%] pr-[2%] pl-[2%] pt-[1%] pb-[1%] dark:text-stone-900 text-stone-50 rounded-t-lg" key={index}>
                    {item}
                </div>
